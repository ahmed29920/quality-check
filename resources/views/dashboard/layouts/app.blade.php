...
<head>
    ...
    <link id="pagestyle" href="{{ asset('dashboard/css/style.css') }}" rel="stylesheet" />
    <!-- Nepcha Analytics (nepcha.com) -->
    <!-- Nepcha is a easy-to-use web analytics. No cookies and fully compliant with GDPR, CCPA and PECR. -->
    <script defer data-site="http://quality-check.test" src="https://api.nepcha.com/js/nepcha-analytics.js"></script>
</head>

<body class="g-sidenav-show  @if (app()->getLocale() == 'ar') rtl @endif bg-gray-100">
