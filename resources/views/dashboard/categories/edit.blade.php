                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="upload-area border-dashed border-2 p-4 text-center position-relative"
                                    ...
                                    <img id="imagePreview" src="{{ $category->image_url }}" alt="Preview"
                                        class="img-fluid rounded {{ $category->image_url ? '' : 'd-none' }} w-100 h-100"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            @php
                                                $isActiveChecked = old('is_active') !== null ? old('is_active') : $category->is_active;
                                            @endphp
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            @php
                                                $hasPricableChecked = old('has_pricable_services') !== null ? old('has_pricable_services') : $category->has_pricable_services;
                                            @endphp
                                            <input type="checkbox" name="has_pricable_services"
                                                id="has_pricable_services" class="form-check-input" value="1"
...
@push('scripts')
    <script>
        ...
        function addOption(button) {
            ...
            const index = Array.from(existingQuestions).indexOf(questionItem);
        ...
        function generateReview() {
            ...
            const formData = new FormData(document.getElementById('categoryWizardForm'));
        ...
        function togglePricingFields() {
            const checkbox = document.getElementById('has_pricable_services');
            const pricingFields = document.getElementById('pricing-fields');
            pricingFields.style.display = checkbox.checked ? 'block' : 'none';
        }
