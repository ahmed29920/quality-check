                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            ...
                            <p class="mb-0">Enter your email and new password to reset your account password.</p>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('reset-password.submit') }}" method="post">
                                @csrf
                                ...
                                <div class="mb-3">
                                    <input type="password" name="password_confirmation" class="form-control" placeholder="Confirm new password"
                                        aria-label="Password Confirmation" aria-describedby="password_confirmation-addon">
                                </div>
